...
```{r data}
euks_complete <- read.csv("/Users/Administrador/Desktop/Camilo/sentrynels/Data/Characterization/Eukaryotes_characterization.csv", 
                          header = TRUE, 
                          sep = ";", 
                          dec = ".", 
                          skip = 0, 
...
```{r}
png("/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Core/Fig_3_complete_upset_eukaryotes.png", width = 50, height = 23, units = "in", res = 300)
...
write.csv2(as.data.frame(t(chanaral_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_001.csv")
...
write.csv2(as.data.frame(t(flamenco_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_002.csv")
...
write.csv2(as.data.frame(t(huasco_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_003.csv")
...
write.csv2(as.data.frame(t(ptachoros_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_004.csv")
...
write.csv2(as.data.frame(t(quintero_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_005.csv")
...
write.csv2(as.data.frame(t(lascruces_abundance[,c(3:65)])), "/Documents/Proyectos_R/sentrynels/Data/Core/unique_006.csv")
```
...
oth <- others[,c(3:65)]
write.csv2(as.data.frame(t(others[,c(3:65)])),"/Documents/Proyectos_R/sentrynels/Data/Core/others.csv")
```
...
```{r}
todas <- euks_upset %>% filter(Las_Cruces == 1)
t <- euks_complete[row.names(euks_complete)%in%row.names(todas), ]
t <- t[,c(3:65)] %>% t() %>% as.data.frame()
write.csv2(t, "/Documents/Proyectos_R/sentrynels/Data/Core/t6.csv")
```

```{r}
compartidas <- euks_upset %>% filter(Chanaral == 1 & Flamenco == 1 & Huasco == 1 & Pta_Choros == 1 & Quintero == 1 & Las_Cruces == 1)
shared <- euks_complete[row.names(euks_complete)%in%row.names(compartidas),]
shared <- shared[,c(3:65)] %>% t() %>% as.data.frame()
write.csv2(shared, "/Documents/Proyectos_R/sentrynels/Data/Core/shared.csv")
```
