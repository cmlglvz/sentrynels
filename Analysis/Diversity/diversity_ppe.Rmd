...
```{r data}
ppe_complete <- read.csv("https://raw.githubusercontent.com/cmlglvz/sentrynels/main/Data/PPE/PPEs_ASV_table.csv", 
                          header = TRUE, 
                          sep = ";", 
                          skip = 0, 
                          row.names = 1)
...
```{r}
abundance <- ppe_complete[,c(3:65)] %>% t() %>% as.data.frame()
taxa <- ppe_complete[,-c(3:72)]
```
...
write.csv(richness, "/Users/Administrador/Desktop/Camilo/sentrynels/Data/Diversity/ppe_richness.csv")
```
...
ggsave(plot = chao1,
       filename = "Fig_21_ppe_chao1_richness.png", 
...
ggsave(plot = ace,
       filename = "Fig_22_ppe_ACE_richness.png", 
       path = "/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Diversity/", 
       width = 15, 
       height = 9, 
       dpi = 600)
...
shannon <- diversity(abundance, index = "shannon", equalize.groups = FALSE) %>% 
  ...
  rename("Shannon" = V1)
write.csv(shannon, "/Users/Administrador/Desktop/Camilo/sentrynels/Data/Diversity/ppe_shannon.csv")
shplot <- shannon %>% 
  ggplot(aes(x = Site, 
             y = Shannon, 
             fill = Site)) + 
...
ggsave(plot = shplot,
       filename = "Fig_23_ppe_shannon_diversity.png", 
       path = "/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Diversity/", 
       width = 15, 
       height = 9, 
       dpi = 600)
...
simpson <- diversity(abundance, index = "simpson", equalize.groups = FALSE) %>% 
  as.matrix() %>% as.data.frame() %>% add_column(Site = environmental$Site, .name_repair = "minimal") %>% 
  rename("Simpson" = V1)
write.csv(simpson, "/Users/Administrador/Desktop/Camilo/sentrynels/Data/Diversity/ppe_simpson.csv")
simplot <- simpson %>% 
  ggplot(aes(x = Site, 
             y = Simpson, 
             fill = Site)) + 
...
ggsave(plot = simplot,
       filename = "Fig_24_ppe_simpson_diversity.png", 
       path = "/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Diversity/", 
       width = 15, 
       height = 9, 
       dpi = 600)
...
write.csv(inv, "/Users/Administrador/Desktop/Camilo/sentrynels/Data/Diversity/ppe_invsimpson_data.csv")
iplot <- inv %>% 
  ggplot(aes(x = Site, 
             y = Invsimpson, 
             fill = Site)) + 
...
ggsave(plot = iplot,
       filename = "Fig_25_ppe_invsimpson_diversity.png", 
       path = "/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Diversity/", 
       width = 15, 
       height = 9, 
       dpi = 600)
...
unbiased <- simpson.unb(x = abundance) %>% 
  as.matrix() %>% as.data.frame() %>% add_column(Site = environmental$Site, .name_repair = "minimal") %>% 
  rename("Unbiased" = V1)
write.csv(unbiased, "/Users/Administrador/Desktop/Camilo/sentrynels/Data/Diversity/ppe_unbiased_simpson.csv")
unbplot <- unbiased %>% 
  ggplot(aes(x = Site, 
             y = Unbiased, 
             fill = Site)) + 
...
ggsave(plot = unbplot,
       filename = "Fig_26_ppe_unbiased_simpson_diversity.png", 
       path = "/Users/Administrador/Desktop/Camilo/sentrynels/Analysis/Diversity/", 
       width = 15, 
       height = 9, 
       dpi = 600)
